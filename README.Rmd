...
?loss_calculate
```
You can also check the full manual on: https://s.stis.ac.id/documentation-metaSVR. 
...
Arini, Rechtiana Putri & Kurniawan, Robert. (2025). metaSVR:
  Support Vector Regression with Metaheuristic Algorithms
  Optimization. R package version 0.1.0.
